...
landscapeNumbersToLetters <- function(number){
  ...
  if(floor(number%%100000/10000)==1) landscapeRating <- paste0(landscapeRating,"T")
  ...
  if(floor(number%%10000/1000)==1) landscapeRating <- paste0(landscapeRating,"P")
  ...
  if(floor(number%%1000/100)==1) landscapeRating <- paste0(landscapeRating,"J")
  ...
  if(floor(number%%100/10)==1) landscapeRating <- paste0(landscapeRating,"K")
  ...
  if(floor(number%%10)==1) landscapeRating <- paste0(landscapeRating,"I")
